				...
				<div in:fade={{ duration: 250 }} class="tab-pane">
					...
					<div class="grid-2-col">
						<div class="setting-card">
							...
							<div class="stepper">
								<button on:click={() => adjustVal('pomodoroLen', -1, 1, 60)}
						...
						<div class="setting-card">
							...
							<div class="stepper">
								<button on:click={() => adjustVal('shortBreak', -1, 1, 30)}
									><Minus size={14} /></button
								>
						...
						<div class="setting-card">
							...
							<div class="stepper">
								<button on:click={() => adjustVal('longBreak', -1, 1, 60)}
									><Minus size={14} /></button
								>
						...
						<div class="setting-card">
							...
							<div class="stepper">
								<button on:click={() => adjustVal('longBreakInterval', -1, 2, 10)}
									><Minus size={14} /></button
								>
					...
					<div class="toggles-container">
						<div class="toggle-row">
							...
							<button
								class="toggle-switch"
								class:checked={settings.autoStartBreaks}
								on:click={() => (settings.autoStartBreaks = !settings.autoStartBreaks)}
							>
								<div class="knob"></div>
							</button>
						</div>
						...
						<div class="toggle-row">
							...
							<button
								class="toggle-switch"
								class:checked={settings.autoStartPomos}
								on:click={() => (settings.autoStartPomos = !settings.autoStartPomos)}
							>
								<div class="knob"></div>
							</button>
						</div>
				...
				<div in:fade={{ duration: 250 }} class="tab-pane">
					...
					<div class="settings-list">
						...
						<div class="list-item">
							...
							<button
								class="toggle-switch"
								class:checked={settings.notifications}
						...
						<div class="plan-content">
							...
							<div class="plan-info">
								...
								<span class="plan-name"
									>{settings.plan === 'pro' ? 'Pro Membership' : 'Free Tier'}</span
								>
							</div>
						</div>
			...
			{#if activeTab === 'support'}
				<div in:fade={{ duration: 250 }} class="tab-pane">
					...
					<div class="feedback-form">
						<textarea placeholder="Tell us what you think..." bind:value={feedbackText}></textarea>

						<div class="form-footer">
							<button
								class="btn-primary"
								on:click={handleFeedback}
								disabled={!feedbackText || feedbackSent}
							>
								{#if feedbackSent}
									<Check size={18} /> Sent!
								{:else}
...
<style>
	...
	.modal-backdrop {
		...
		align-items: center;
		width: 100%;
		height: 100%; /* offset from top nav */
	}
